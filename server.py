...
def setup_profile(
    ...
    result["instructions"] = (
        ...
        "WRITING STYLE — bullets must sound like a real person wrote them, not an AI:\n"
        "- Use plain action verbs: Built, Wrote, Led, Reduced, Cut, Added, Fixed, Shipped, Ran, Designed\n"
        "- Do NOT use: leveraged, utilized, spearheaded, orchestrated, streamlined, fostered, championed, "
        "pioneered, revolutionized, holistic, robust, seamless, cutting-edge, state-of-the-art, innovative, "
        "synergy, pivotal, meticulous, transformative, paradigm, delve, nuanced\n"
        "- Do NOT use em dashes (—). Use a hyphen (-) or restructure the sentence\n"
        "- Write 'to' not 'in order to'\n"
        "- Keep sentences direct and specific. Bad: 'Leveraged React to deliver seamless UX.' "
        "Good: 'Built the frontend in React; load time dropped 40%.'"
    )
...
def hiring_manager_review():
    ...
    return (
        ...
        "(%, $, users, scale), strong action verbs (Built > Worked on), "
        ...
        "trajectory. 'Used Python' is weaker than 'Built distributed services in Python'.\n\n"
        ...
        "CRITICAL — WRITING STYLE: Rewritten bullets must sound like a human wrote them.\n"
        "BANNED words/phrases (these are AI red flags — never use them):\n"
        "  leveraged, utilized, spearheaded, orchestrated, streamlined, fostered, championed,\n"
        "  pioneered, revolutionized, holistic, robust, seamless, cutting-edge, state-of-the-art,\n"
        "  innovative, synergy, pivotal, meticulous, transformative, paradigm, delve, nuanced,\n"
        "  game-changing, groundbreaking, in order to\n"
        "BANNED punctuation: em dash (—). Use a hyphen or rewrite the clause.\n"
        "USE INSTEAD: plain, specific verbs — Built, Wrote, Led, Cut, Reduced, Fixed, Shipped, "
        "Ran, Designed, Tested, Moved, Launched, Grew, Saved\n"
        "EXAMPLE rewrite:\n"
        "  Bad:  'Leveraged React to orchestrate a seamless, cutting-edge user experience'\n"
        "  Good: 'Built the frontend in React; bounce rate dropped 18% after launch'"
    )
